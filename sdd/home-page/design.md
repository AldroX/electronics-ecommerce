...
All section components (`HeroSection`, `CategoriesSection`, `FeaturedProducts`,
`BestSellers`, `TrustSection`) accept **no props** — they load data internally
via helpers in frontmatter.
...
- Data files (`products.json`, `categories.json`, `solutions.json`, `kits.json`)
  are populated in the same commit.
...
_Generated: 2026-08-27 | SDD Phase: DESIGN | Change: home-page | Approach: A
(Full MVP Home)_
