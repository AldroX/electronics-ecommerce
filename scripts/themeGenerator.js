...
function generateThemeCSS() {
  ...
  try {
    ...
    // NOTE: Dark mode colors skipped — deferred per design decision
    // To add later: add a "darkmode" section to theme.json and process here
